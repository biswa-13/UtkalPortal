...
module.exports = {
  ...
  deptrn: 'Please enter your Dept. roll no. eg : 11IMCA006',
  graterthan: 'Passing year must be grater than joining year',
  year: 'Must be a valid year',
  percent: 'Must be a valid percent',
  per: 'Must be a valid per',
  stream: 'Type your Stream/Branch'
...
module.exports = {
  ...
  /* Added for pcell*/
  fullname: /^[a-zA-Z]([-']?[a-z]+)*( [a-zA-Z]([-']?[a-z]+)*)+$/,
  deptrn: /^[a-zA-Z0-9_](?=[\w.]{5,12}$)\w*\.?\w*$/i,
  first_name: /^[a-zA-Z ]{3,30}$/,
  ...
  graterthan: function(input, value, target) {
