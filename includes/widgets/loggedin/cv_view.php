			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Update CV (Please Update Only <font color="red">PDF</font> files)</h3>
					...
					<div class="content-module-main cf">
						...
						?>
						<embed src="usr_cv/<?php echo $name;?>.pdf" width=800px height=2100px>
					   ...
					   if (is_uploaded_file($_FILES['classnotes']['tmp_name'])) {
						  ...
						  if ($_FILES['classnotes']['type'] !== "application/pdf") {
							 ...
							 //$sql="UPDATE `user_cv` SET `cv_file_name` (`user_id`, `cv_file_name`) VALUES ($id, '$name')";
							//mysql_query($sql);
					...
					?>
							<form action="" enctype="multipart/form-data" method="post">
								...
								<fieldset>
									<label for="simple-input">Update Your New CV</label>
